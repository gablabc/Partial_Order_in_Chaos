...
if __name__ == "__main__":
    ...
    for degree in degrees:
        ...
        if degree == 2:
            ...
            bar(PO.phi_mean, reorder_feature_names, threshold=tau, xerr=widths.T)
            plt.savefig(os.path.join(save_path, "PO", f"Global_Importance.pdf"), bbox_inches='tight')

            # Print PO
            dot = PO.print_hasse_diagram(show_ambiguous=False)
            filename = f"PO_Global_Importance"
